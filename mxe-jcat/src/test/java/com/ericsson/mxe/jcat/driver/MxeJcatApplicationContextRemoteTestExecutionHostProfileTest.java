...
public class MxeJcatApplicationContextRemoteTestExecutionHostProfileTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(MxeJcatApplicationContextRemoteTestExecutionHostProfileTest.class);
    ...
    public static void beforeClassSetup() {
        LOGGER.info("[testClass: {}, commandProfile: {}]", MxeJcatApplicationContextRemoteTestExecutionHostProfileTest.class.getSimpleName(),
    ...
    public void beforeMethod() {
        ...
        MxeJcatApplicationContextProvider.setActiveProfiles(TestExecutionHostProfiles.REMOTE);
    }
    ...
    public void testContextShouldInitProperMxeCliDriverType() {
        ...
        assertThat(DriverFactory.getMxeCliDriver(testExecutionHost), instanceOf(RemoteMxeCliDriver.class));
    }
