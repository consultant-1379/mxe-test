...
public class AutoWiredApplicationContextLocalTestExecutionHostProfile {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AutoWiredApplicationContextLocalTestExecutionHostProfile.class);
    ...
    public static void beforeClassSetup() {
        LOGGER.info("[testClass: {}, commandProfile: {}]", AutoWiredApplicationContextLocalTestExecutionHostProfile.class.getSimpleName(),
    ...
    public void testContextShouldInitProperMxeCliDriverType() {
        ...
        assertThat(applicationContext.getBean(MxeCliDriver.class, testExecutionHost), instanceOf(LocalMxeCliDriver.class));
    }
